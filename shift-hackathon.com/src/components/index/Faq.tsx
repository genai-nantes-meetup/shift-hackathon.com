...
const ITEMS = [
  {
    ...
    answer: "Pour que tous les participants soient sur le même pied d'égalité, il ne faut pas avoir commencé à travailler sur l'idée en amont",
  },
  {
  ...
  },
  {
    ...
    answer: "Via le tram 1, le bus 11, en voiture au parking Graslin ou en vélo, parking juste devant.",
  },
  {
    question: "Est-ce que je peux rester dormir ?",
    answer: "Le vendredi soir, non. Le samedi, oui ! Par contre prévois un duvet, un tapis de sol (si pas assez de banquettes), un masque de nuit et des boules quies ;)",
  },
];
