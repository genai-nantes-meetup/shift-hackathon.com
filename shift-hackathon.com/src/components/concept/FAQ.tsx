  ...
  return (
    <section style={{ padding: '5rem 2rem', background: '#0e0218' }}>
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        <Reveal>
          <h2 style={{ fontFamily: '"Agrandir Grand Heavy", sans-serif', fontSize: '48px', fontWeight: 800, color: '#fff', textTransform: 'uppercase', textAlign: 'center', marginBottom: '2.5rem' }}>FAQ</h2>
        </Reveal>
        {FAQ_DATA.map((item, i) => (
          <Reveal key={i} delay={i * 0.04}>
            <div style={{ borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
              ...
              >
                ...
                <span style={{ color: '#9ff839', flexShrink: 0, fontSize: '1.25rem', transition: 'transform 0.2s', transform: open === i ? 'rotate(45deg)' : 'none' }}>+</span>
              </button>
              {open === i && (
