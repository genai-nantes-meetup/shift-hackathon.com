...
export const SCHEDULE = [
  {
    ...
    slots: [
      { time: '18h', title: 'Accueil' },
      {
        ...
        speakers: [
          { name: 'Maxime Thoonsen', img: `${CDN}/pYjvK6nHyafc9PIC9N743fp6XY.jpeg` },
          { name: 'Samuel Berthe', img: `${CDN}/9TWFt2MaEnioV0ad4CERDS3PcI.jpg` },
        ],
      },
      ...
      },
      {
        ...
        speakers: [{ name: 'Pierre Renaudin', img: `${CDN}/hYJgyDzLHnUwjvqtMwSI8SzH8.jpeg` }],
      },
      {
        time: '21h45',
